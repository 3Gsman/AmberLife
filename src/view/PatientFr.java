...
public class PatientFr extends JFrame {
	...
	public void initialize() throws IOException {
		...
		lblNewLabel_1.setIcon(new ImageIcon(PatientFr.class.getResource("/resources/user.png")));
		...
		JLabel lblNameXxxxx = new JLabel(" name : " + " fromcontroller");
		...
		JLabel lblSsnXxxxx = new JLabel(" surname : " + " fromcontroller");
		sf = font.deriveFont(22f);
		...
		JLabel lblPhoneXxxxx = new JLabel(" i.d : " + " fromcontroller");
		sf = font.deriveFont(22f);
		...
		JLabel lblNewLabel = new JLabel("user: " + " fromcontroller");
