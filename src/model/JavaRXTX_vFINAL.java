...
public class JavaRXTX_vFINAL extends javax.swing.JFrame {
	
    private PanamaHitek_Arduino ino = new PanamaHitek_Arduino();    
    private static Vector<Double> ecg = new Vector<Double>();
    ...
    public static void main(String args[]) {
       ...
       //  * For details see http://download.oracle.com/javase/tutorial/uiswing/lookandfeel/plaf.html 
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaRXTX_vFINAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       //  Create and display the form 
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JavaRXTX_vFINAL().setVisible(true);
            }
        });
    }
