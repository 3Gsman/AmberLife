...
public class FileManagement {
	...
	/**
	 * Checks whether an user exists or not by reading into the DB (currently a
	 * txt file as a placeholder) and if it does, returns the type of user that
	 * it is (Assistant, Doctor, or Admin)
	 * 
	 * @param usuario
	...
	/**
	 * Checks whether a patient exists within the DB using their id number
	 * (Currently a txt file as a placeholder) and returns an array containing
	 * the data that the Assistant has the authorization to see, to protect
	...
	/**
	 * Checks whether a patient exists within the DB using their ssn number
	 * (Currently a txt file as a placeholder) and returns an array containing
	 * the data that the Assistant has the authorization to see, to protect
	 * confidential information.
	 * 
	...
	/**
	 * Gets all assistants from the DB (currently a txt file) and returns a list
	 * with their data.
	 * 
	...
	/**
	 * Gets all doctors from the DB (currently a txt file) and returns a list
	 * with their data.
	 * 
	...
	/**
	 * Checks whether a patient exists in the DB (currently txt files) and
	 * returns their data as a Patient object, containing confidential
	 * information that only Doctors may see.
	 * 
	 * @param username
	...
	/**
	 * Reads a list of all messages relating to a patient from the DB (currently
	 * txt files)
	 * 
	 * @param number
